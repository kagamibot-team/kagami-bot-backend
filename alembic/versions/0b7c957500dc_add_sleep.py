...
def upgrade() -> None:
    ...
    with op.batch_alter_table('catch_user_data', schema=None) as batch_op:
        batch_op.add_column(sa.Column('last_sleep_early_time', sa.Float(), server_default='0', nullable=False))
        batch_op.add_column(sa.Column('sleep_early_count', sa.Integer(), server_default='0', nullable=False))
