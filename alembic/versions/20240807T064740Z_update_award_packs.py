...
def upgrade() -> None:
    ...
    with op.batch_alter_table('catch_award', schema=None) as batch_op:
        batch_op.add_column(sa.Column('belong_pack', sa.String(), server_default='', nullable=False))

    with op.batch_alter_table('catch_user_data', schema=None) as batch_op:
        batch_op.add_column(sa.Column('using_packs', sa.String(), server_default='', nullable=False))
