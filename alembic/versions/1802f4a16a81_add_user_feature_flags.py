...
def upgrade() -> None:
    ...
    with op.batch_alter_table('catch_user_data', schema=None) as batch_op:
        batch_op.add_column(sa.Column('last_sign_in_time', sa.Float(), server_default='0', nullable=False))
        batch_op.add_column(sa.Column('sign_in_count', sa.Integer(), server_default='0', nullable=False))
        batch_op.add_column(sa.Column('feature_flag', sa.String(), server_default='', nullable=False))
